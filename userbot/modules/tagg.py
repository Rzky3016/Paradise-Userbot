...
CMD_HELP.update({
    'tags':
    "CMD: `.tags all`"
    "\nPejelasan : Tag Top 100 Members of chat."
    "\n\nCMD: `.tags admin`"
    "\nPenjelasan: Tag Admins of that chat."
    "\n\nCMD: `.tags owner`"
    "\nPenjelasan: Tag Owner of that chat."
    "\n\nCMD: `.tags bot`"
    "\nPenjelasan: Tag Bots of that chat."
    "\n\nCMD: `.tags rec`"
    "\nPenjelasan: Tag recently Active Members."
    "\n\nCMD: `.tags on`"
    "\nPenjelasan: Tag online Members(work only if privacy off)."
    "\n\nCMD: `.tags off`"
    "\nPenjelasan: Tag Offline Members(work only if privacy off)."
})
